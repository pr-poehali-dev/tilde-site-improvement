...
const practices = [
  ...
  {
    icon: 'TrendingUp',
    title: 'Финансовые споры',
    desc: 'Защита интересов клиентов в спорах с банками, страховыми компаниями, взыскание задолженностей и сопровождение финансовых сделок.',
    items: ['Споры с банками', 'Страховые споры', 'Взыскание долгов', 'Реструктуризация'],
  },
  {
    icon: 'FileText',
    title: 'Договорная работа',
    desc: 'Разработка, проверка и сопровождение договоров любой сложности. Минимизация правовых рисков для физических и юридических лиц.',
    items: ['Составление договоров', 'Правовая экспертиза', 'Преддоговорные споры', 'Сопровождение сделок'],
  },
];
